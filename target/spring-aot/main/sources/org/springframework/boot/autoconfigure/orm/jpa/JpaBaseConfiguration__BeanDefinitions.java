...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.bank.soft.domain.models.Account", "com.bank.soft.domain.models.BaseItem", "com.bank.soft.domain.models.Card", "com.bank.soft.domain.models.Feature", "com.bank.soft.domain.models.News", "com.bank.soft.domain.models.User");
