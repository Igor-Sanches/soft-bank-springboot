package com.bank.soft.domain.repository;
...
public class UserRepository__BeanDefinitions {
  ...
  public static BeanDefinition getUserRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.bank.soft.domain.repository.UserRepository");
